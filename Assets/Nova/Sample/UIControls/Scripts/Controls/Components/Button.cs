...
namespace NovaSamples.UIControls
{
    ...
    public class Button : UIControl<ButtonVisuals>
    {
        ...
        [Tooltip("Event fired when the button is hovered.")]
        public UnityEvent OnHovered = null;
        ...
        private void HandleHovered(Gesture.OnHover evt, ButtonVisuals visuals) => OnHovered?.Invoke();
    }
}
