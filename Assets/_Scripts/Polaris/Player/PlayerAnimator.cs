...
namespace SupanthaPaul
{
	public class PlayerAnimator : MonoBehaviour
	{
        ...
        private static readonly int IsBackwardwalking = Animator.StringToHash("IsBackwardWalking");
		...
		private void Update()
		{
			...
			if (m_controller.isBackwardMoving)
			{
				m_anim.SetBool(IsBackwardwalking, true);
			}
            else
            {
                m_anim.SetBool(IsBackwardwalking, false);
            }
